      ...
      <header className="header">
        <div className="header-container">
          ...
          <div className="header-right">
            {isAuthenticated ? (
              <>
                <button className="icon-btn" onClick={() => navigate('/')} title="Eventos">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 9.5V19a2 2 0 002 2h3a2 2 0 002-2v-4h2v4a2 2 0 002 2h3a2 2 0 002-2V9.5a2 2 0 00-.77-1.57l-7-5.5a2 2 0 00-2.46 0l-7 5.5A2 2 0 003 9.5z" />
                  </svg>
                </button>
          ...
          <div className={`drawer open`}>
            <div className="drawer-content">
              ...
              <div className="drawer-menu">
                {isAuthenticated ? (
                  <>
                    <button className="drawer-item" onClick={() => handleNavigate('/')}> 
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 9.5V19a2 2 0 002 2h3a2 2 0 002-2v-4h2v4a2 2 0 002 2h3a2 2 0 002-2V9.5a2 2 0 00-.77-1.57l-7-5.5a2 2 0 00-2.46 0l-7 5.5A2 2 0 003 9.5z" />
                      </svg>
                      <span>Eventos</span>
                    </button>
                    <button className="drawer-item" onClick={() => handleNavigate('/my-tickets')}> 
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <rect x="3" y="6" width="18" height="12" rx="2" />
                        <circle cx="3" cy="12" r="2" fill="currentColor" />
                        <circle cx="21" cy="12" r="2" fill="currentColor" />
