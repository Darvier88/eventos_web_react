      ...
      <div className="footer-container">
        ...
        <div className="footer-brand">
          ...
          <div className="footer-social">
            {/* Instagram */}
            <a href="https://www.instagram.com/macak_ec/" target="_blank" rel="noreferrer" className="social-link" aria-label="Instagram">
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            <li><Link to="/legal/terms">Términos y condiciones</Link></li>
            <li><Link to="/legal/privacy">Política de uso de datos</Link></li>
            <li><Link to="/legal/recargas">Política de recargas NFC</Link></li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-contact">
            ...
            <li>
              ...
              <span>gerencia@velecas.com</span>
            </li>
            <li>
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
